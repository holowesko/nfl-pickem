 ...
 *
 * Controlled, so it can be opened from the button on the Picks tab or from a
 * week row on the Leaderboard.
 */
export function PickSummaryDialog({
  week,
  players,
  rows,
  open,
        ...
        {rows.map((row) => (
          ...
          >
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[0.7rem] text-muted">{row.score ?? row.kickoffLabel}</p>
            </div>
...
/** The Picks tab's own trigger: a button beside the week heading. */
